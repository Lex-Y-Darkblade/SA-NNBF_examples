...
mole_name = "H12"
pth_file = "./ham_h12_4Bohr_oao.pth"  
tree = "./spin_6+6-_4terms.npz"
...
max_lr = 1e-3
def lr_sh(t):
    return min(max_lr, max_lr/10**((t-3000)/1000))
...
full_label = f"{mole_name}({ansatz_str},{hidden_num})-{seed}-{tmp_str}"
...
if __name__ == "__main__":
    ...
    # tmp_str = random_str()
    dtype_config.apply(use_complex=False, use_float64=True, device=device)
